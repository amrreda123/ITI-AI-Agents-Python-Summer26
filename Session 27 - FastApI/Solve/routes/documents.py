...
@router.get(
    ...
    description="Retrieve all documents from SQLite persistence layer.",
)
def list_documents():
...
@router.post(
    ...
    description="Create and persist a new document in SQLite.",
)
...
@router.put(
    ...
    description="Update an existing document in SQLite.",
    responses={
        404: {
            "description": "Document not found",
            "content": {
